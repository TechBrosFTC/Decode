...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2671.2628723762955; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4220.468605349771; // x position of the perpendicular encoder (in tick units)
    }
